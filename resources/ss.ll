; ModuleID = 'ss.c'
source_filename = "ss.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@main.b = private unnamed_addr constant [10 x i32] [i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1], align 16
...
define i32 @main() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %9, i8* bitcast ([10 x i32]* @main.b to i8*), i64 40, i32 16, i1 false)
...
; <label>:45:                                     ; preds = %10
  %46 = getelementptr inbounds [10 x i32], [10 x i32]* %4, i64 0, i64 9
