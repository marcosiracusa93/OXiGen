...
namespace oxigen{
    ...
    private:
        ...
        llvm::Loop* getCommonLoopParent(DFGNode* n_1,DFGNode* n_2,llvm::LoopInfo *LI, llvm::Function *F);

        void createLoopNodes(DFGNode *node, llvm::LoopInfo *LI,
                             llvm::Function *F,llvm::ScalarEvolution* SE,DFG* dfg);
